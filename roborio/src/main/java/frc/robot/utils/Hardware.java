...
public final class Hardware {
    ...
    public static final CANSparkMax transportBottom = new CANSparkMax(8, MotorType.kBrushless); //Not final ID;
    ...
    public static final CANSparkMax intake = new CANSparkMax(14, MotorType.kBrushless); //Not final ID
